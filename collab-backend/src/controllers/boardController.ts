...
export const getProjectBoard = async (req: AuthenticatedRequest, res: Response): Promise<void> => {
  try {
...
export const updateTaskPosition = async (req: AuthenticatedRequest, res: Response): Promise<void> => {
  try {
